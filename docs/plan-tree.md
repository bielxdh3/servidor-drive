...
- `[NEXT]` Phase 9 foundation is separately authorized but remains `NOT_STARTED`: begin only the bounded documentation/implementation foundation on its separate branch/PR, without claiming vectors, interoperability, runtime crypto, migration, or release acceptance.
